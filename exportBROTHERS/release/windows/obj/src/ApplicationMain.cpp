...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("180",69,5f,25,00));
...
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin' Vacation",10,18,71,10));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friday Night Funkin' Vacation",10,18,71,10))
