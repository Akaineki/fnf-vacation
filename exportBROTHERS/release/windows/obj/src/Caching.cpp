...
HXLINE(  54)		::haxe::Log_obj::trace(HX_("starting caching..",9f,ab,b0,07),::hx::SourceInfo(HX_("source_BROTHERS/Caching.hx",f7,cd,90,a5),54,HX_("Caching",df,bf,75,f0),HX_("create",fc,66,0f,7c)));
...
HXLINE(  87)		::haxe::Log_obj::trace(HX_("caching images...",d5,2a,c5,d3),::hx::SourceInfo(HX_("source_BROTHERS/Caching.hx",f7,cd,90,a5),87,HX_("Caching",df,bf,75,f0),HX_("cache",42,9a,14,41)));
HXLINE(  89)		{
HXLINE(  89)			int _g = 0;
...
HXLINE(  96)		::haxe::Log_obj::trace(HX_("caching music...",aa,84,e5,3a),::hx::SourceInfo(HX_("source_BROTHERS/Caching.hx",f7,cd,90,a5),96,HX_("Caching",df,bf,75,f0),HX_("cache",42,9a,14,41)));
HXLINE(  98)		{
HXLINE(  98)			int _g2 = 0;
...
HXLINE( 105)		::haxe::Log_obj::trace(((HX_("LOADING: ",02,24,79,41) + this->toBeDone) + HX_(" OBJECTS.",1a,01,df,3a)),::hx::SourceInfo(HX_("source_BROTHERS/Caching.hx",f7,cd,90,a5),105,HX_("Caching",df,bf,75,f0),HX_("cache",42,9a,14,41)));
HXLINE( 107)		{
...
HXLINE( 111)				::haxe::Log_obj::trace((HX_("cached ",fe,85,21,23) + replaced),::hx::SourceInfo(HX_("source_BROTHERS/Caching.hx",f7,cd,90,a5),111,HX_("Caching",df,bf,75,f0),HX_("cache",42,9a,14,41)));
...
HXLINE( 119)				::haxe::Log_obj::trace((HX_("cached ",fe,85,21,23) + i),::hx::SourceInfo(HX_("source_BROTHERS/Caching.hx",f7,cd,90,a5),119,HX_("Caching",df,bf,75,f0),HX_("cache",42,9a,14,41)));
HXLINE( 120)				this->done++;
            			}
            		}
HXLINE( 123)		::haxe::Log_obj::trace(HX_("Finished caching...",1d,3f,52,1a),::hx::SourceInfo(HX_("source_BROTHERS/Caching.hx",f7,cd,90,a5),123,HX_("Caching",df,bf,75,f0),HX_("cache",42,9a,14,41)));
HXLINE( 125)		{
