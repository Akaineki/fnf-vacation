...
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_545_update,"Character","update",0x0e18944e,"Character.update","Character.hx",545,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_582_dance,"Character","dance",0xde4da48e,"Character.dance","Character.hx",582,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_643_playAnim,"Character","playAnim",0xed2bd3aa,"Character.playAnim","Character.hx",643,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_674_addOffset,"Character","addOffset",0x6dc9376f,"Character.addOffset","Character.hx",674,0xf073a2d5)
...
HXLINE( 273)			::haxe::Log_obj::trace(tex1->frames->length,::hx::SourceInfo(HX_("source_BROTHERS/Character.hx",8d,d6,d9,59),273,HX_("Character",89,bb,a4,e3),HX_("new",60,d0,53,00)));
...
HXLINE( 109)			goto _hx_goto_0;
            		...
            		if (  (_hx_switch_0==HX_("joao-tubarao",c6,4f,aa,c7)) ){
HXLINE( 503)			::String library = null();
HXDLIN( 503)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("joao_tubarao/joao_assets",94,29,48,3b)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 503)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("joao_tubarao/joao_assets",94,29,48,3b)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 504)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("Joao idle",41,19,6d,9c),24,false,null(),null());
HXLINE( 505)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("Joao cima",a7,9d,79,98),24,false,null(),null());
HXLINE( 506)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("Joao baixo",74,16,3d,39),24,false,null(),null());
HXLINE( 507)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("Joao esquerda",a9,f5,bc,4c),24,false,null(),null());
HXLINE( 508)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("Joao direita",91,6e,94,7b),24,false,null(),null());
...
HXLINE( 142)			goto _hx_goto_0;
            		...
            		_hx_goto_0:;
HXLINE( 519)		this->dance();
HXLINE( 521)		if (( (bool)(isPlayer) )) {
HXLINE( 523)			this->set_flipX(!(this->flipX));
HXLINE( 526)			if (!(::StringTools_obj::startsWith(this->curCharacter,HX_("bf",c4,55,00,00)))) {
HXLINE( 529)				::Array< int > oldRight = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHT",0d,6f,70,ac))) )->frames;
HXLINE( 530)				( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHT",0d,6f,70,ac))) )->frames = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFT",d6,39,ef,3b))) )->frames;
HXLINE( 531)				( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFT",d6,39,ef,3b))) )->frames = oldRight;
HXLINE( 534)				if (::hx::IsNotNull( this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3)) )) {
HXLINE( 536)					::Array< int > oldMiss = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3))) )->frames;
HXLINE( 537)					( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3))) )->frames = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFTmiss",d2,2f,9c,b6))) )->frames;
HXLINE( 538)					( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFTmiss",d2,2f,9c,b6))) )->frames = oldMiss;
            				}
            			}
            		}
            	}
...
void Character_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_545_update)
HXLINE( 546)		if (!(::StringTools_obj::startsWith(this->curCharacter,HX_("bf",c4,55,00,00)))) {
HXLINE( 548)			if (::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("sing",4f,96,53,4c))) {
HXLINE( 550)				 ::Character _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 550)				_hx_tmp->holdTimer = (_hx_tmp->holdTimer + elapsed);
            			}
HXLINE( 553)			Float dadVar = ( (Float)(4) );
HXLINE( 555)			if ((this->curCharacter == HX_("dad",47,36,4c,00))) {
HXLINE( 556)				dadVar = ((Float)6.1);
            			}
HXLINE( 557)			if ((this->holdTimer >= ((::Conductor_obj::stepCrochet * dadVar) * ((Float)0.001)))) {
HXLINE( 559)				::haxe::Log_obj::trace(HX_("dance",33,83,83,d4),::hx::SourceInfo(HX_("source_BROTHERS/Character.hx",8d,d6,d9,59),559,HX_("Character",89,bb,a4,e3),HX_("update",09,86,05,87)));
HXLINE( 560)				this->dance();
HXLINE( 561)				this->holdTimer = ( (Float)(0) );
            			}
            		}
HXLINE( 565)		if ((this->curCharacter == HX_("gf",1f,5a,00,00))) {
HXLINE( 568)			bool _hx_tmp;
HXDLIN( 568)			if ((this->animation->_curAnim->name == HX_("hairFall",bd,48,d6,cb))) {
HXLINE( 568)				_hx_tmp = this->animation->_curAnim->finished;
            			}
            			else {
...
HXLINE( 572)		this->super::update(elapsed);
            	}


void Character_obj::dance(){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_582_dance)
HXDLIN( 582)		if (!(this->debugMode)) {
HXLINE( 584)			::String _hx_switch_0 = this->curCharacter;
            			if (  (_hx_switch_0==HX_("gf",1f,5a,00,00)) ){
HXLINE( 587)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 589)					this->danced = !(this->danced);
HXLINE( 591)					if (this->danced) {
HXLINE( 592)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 594)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 587)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("gf-car",a6,63,ab,07)) ){
HXLINE( 609)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 611)					this->danced = !(this->danced);
HXLINE( 613)					if (this->danced) {
HXLINE( 614)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 616)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 609)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("gf-christmas",94,26,b1,6d)) ){
HXLINE( 598)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 600)					this->danced = !(this->danced);
HXLINE( 602)					if (this->danced) {
HXLINE( 603)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 605)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 598)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("gf-pixel",98,3e,8c,55)) ){
HXLINE( 619)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 621)					this->danced = !(this->danced);
HXLINE( 623)					if (this->danced) {
HXLINE( 624)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 626)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
...
HXLINE( 629)				goto _hx_goto_21;
            			...
            			/* default */{
HXLINE( 637)				this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
            			}
            			_hx_goto_21:;
            		}
            	}
...
void Character_obj::playAnim(::String AnimName,::hx::Null< bool >  __o_Force,::hx::Null< bool >  __o_Reversed,::hx::Null< int >  __o_Frame){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_643_playAnim)
HXLINE( 644)		this->animation->play(AnimName,Force,Reversed,Frame);
HXLINE( 646)		::cpp::VirtualArray daOffset = ( (::cpp::VirtualArray)(this->animOffsets->get(AnimName)) );
HXLINE( 647)		if (this->animOffsets->exists(AnimName)) {
HXLINE( 649)			this->offset->set(daOffset->__get(0),daOffset->__get(1));
            		}
            		else {
HXLINE( 652)			this->offset->set(0,0);
            		}
HXLINE( 654)		if ((this->curCharacter == HX_("gf",1f,5a,00,00))) {
HXLINE( 656)			if ((AnimName == HX_("singLEFT",d6,39,ef,3b))) {
HXLINE( 658)				this->danced = true;
            			}
            			else {
HXLINE( 660)				if ((AnimName == HX_("singRIGHT",0d,6f,70,ac))) {
HXLINE( 662)					this->danced = false;
            				}
            			}
HXLINE( 665)			bool _hx_tmp;
HXDLIN( 665)			if ((AnimName != HX_("singUP",6a,52,21,b9))) {
HXLINE( 665)				_hx_tmp = (AnimName == HX_("singDOWN",31,2a,ad,36));
            			}
            			else {
HXLINE( 665)				_hx_tmp = true;
            			}
HXDLIN( 665)			if (_hx_tmp) {
HXLINE( 667)				this->danced = !(this->danced);
            			}
            		}
            	}
...
void Character_obj::addOffset(::String name,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_674_addOffset)
HXDLIN( 674)		::cpp::VirtualArray v = ::Array_obj< Float >::__new(2)->init(0,x)->init(1,y);
HXDLIN( 674)		this->animOffsets->set(name,v);
            	}
