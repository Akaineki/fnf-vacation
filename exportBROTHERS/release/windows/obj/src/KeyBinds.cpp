...
HXLINE(  36)			::haxe::Log_obj::trace(HX_("No UP",ba,80,b8,32),::hx::SourceInfo(HX_("source_BROTHERS/KeyBinds.hx",4f,a4,be,57),36,HX_("KeyBinds",17,72,1b,d1),HX_("keyCheck",a9,3e,20,8a)));
            		}
...
HXLINE(  42)			::haxe::Log_obj::trace(HX_("No DOWN",81,8c,28,a7),::hx::SourceInfo(HX_("source_BROTHERS/KeyBinds.hx",4f,a4,be,57),42,HX_("KeyBinds",17,72,1b,d1),HX_("keyCheck",a9,3e,20,8a)));
            		}
...
HXLINE(  48)			::haxe::Log_obj::trace(HX_("No LEFT",26,9c,6a,ac),::hx::SourceInfo(HX_("source_BROTHERS/KeyBinds.hx",4f,a4,be,57),48,HX_("KeyBinds",17,72,1b,d1),HX_("keyCheck",a9,3e,20,8a)));
            		}
...
HXLINE(  54)			::haxe::Log_obj::trace(HX_("No RIGHT",bd,12,eb,a7),::hx::SourceInfo(HX_("source_BROTHERS/KeyBinds.hx",4f,a4,be,57),54,HX_("KeyBinds",17,72,1b,d1),HX_("keyCheck",a9,3e,20,8a)));
            		}
...
HXLINE(  61)			::haxe::Log_obj::trace(HX_("No GUP",23,87,ad,2e),::hx::SourceInfo(HX_("source_BROTHERS/KeyBinds.hx",4f,a4,be,57),61,HX_("KeyBinds",17,72,1b,d1),HX_("keyCheck",a9,3e,20,8a)));
            		}
...
HXLINE(  65)			::haxe::Log_obj::trace(HX_("No GDOWN",2a,bf,3a,4f),::hx::SourceInfo(HX_("source_BROTHERS/KeyBinds.hx",4f,a4,be,57),65,HX_("KeyBinds",17,72,1b,d1),HX_("keyCheck",a9,3e,20,8a)));
            		}
...
HXLINE(  69)			::haxe::Log_obj::trace(HX_("No GLEFT",cf,ce,7c,54),::hx::SourceInfo(HX_("source_BROTHERS/KeyBinds.hx",4f,a4,be,57),69,HX_("KeyBinds",17,72,1b,d1),HX_("keyCheck",a9,3e,20,8a)));
            		}
...
HXLINE(  73)			::haxe::Log_obj::trace(HX_("No GRIGHT",f4,33,c5,0f),::hx::SourceInfo(HX_("source_BROTHERS/KeyBinds.hx",4f,a4,be,57),73,HX_("KeyBinds",17,72,1b,d1),HX_("keyCheck",a9,3e,20,8a)));
            		}
HXLINE(  75)		if (::hx::IsNull( ::flixel::FlxG_obj::save->data->__Field(HX_("killBind",7b,28,25,80),::hx::paccDynamic) )) {
HXLINE(  76)			::flixel::FlxG_obj::save->data->__SetField(HX_("killBind",7b,28,25,80),HX_("R",52,00,00,00),::hx::paccDynamic);
HXLINE(  77)			::haxe::Log_obj::trace(HX_("No KILL",bd,73,c4,ab),::hx::SourceInfo(HX_("source_BROTHERS/KeyBinds.hx",4f,a4,be,57),77,HX_("KeyBinds",17,72,1b,d1),HX_("keyCheck",a9,3e,20,8a)));
            		}
HXLINE(  80)		 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN(  80)		::String _hx_tmp1 = ((HX_("",00,00,00,00) + ::Std_obj::string( ::Dynamic(::flixel::FlxG_obj::save->data->__Field(HX_("leftBind",64,39,12,48),::hx::paccDynamic)))) + HX_("-",2d,00,00,00));
HXDLIN(  80)		::String _hx_tmp2 = ((_hx_tmp1 + ::Std_obj::string( ::Dynamic(::flixel::FlxG_obj::save->data->__Field(HX_("downBind",3f,f3,fe,75),::hx::paccDynamic)))) + HX_("-",2d,00,00,00));
HXDLIN(  80)		::String _hx_tmp3 = ((_hx_tmp2 + ::Std_obj::string( ::Dynamic(::flixel::FlxG_obj::save->data->__Field(HX_("upBind",b8,51,92,70),::hx::paccDynamic)))) + HX_("-",2d,00,00,00));
HXDLIN(  80)		::String _hx_tmp4 = (_hx_tmp3 + ::Std_obj::string( ::Dynamic(::flixel::FlxG_obj::save->data->__Field(HX_("rightBind",b9,4b,dd,ab),::hx::paccDynamic))));
HXDLIN(  80)		_hx_tmp(_hx_tmp4,::hx::SourceInfo(HX_("source_BROTHERS/KeyBinds.hx",4f,a4,be,57),80,HX_("KeyBinds",17,72,1b,d1),HX_("keyCheck",a9,3e,20,8a)));
            	}
