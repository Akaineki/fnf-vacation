...
HXLINE( 249)			::haxe::Log_obj::trace(HX_("Freeplay Menu Selected",9c,6d,5a,ca),::hx::SourceInfo(HX_("source_BROTHERS/MainMenuState.hx",bd,27,14,84),249,HX_("MainMenuState",59,88,5e,20),HX_("goToState",4e,a5,e1,c9)));
...
HXLINE( 245)			::haxe::Log_obj::trace(HX_("Story Menu Selected",71,ff,9b,4a),::hx::SourceInfo(HX_("source_BROTHERS/MainMenuState.hx",bd,27,14,84),245,HX_("MainMenuState",59,88,5e,20),HX_("goToState",4e,a5,e1,c9)));
