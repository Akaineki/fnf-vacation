...
HXLINE(  56)		this->animation->addByPrefix(HX_("joao-tubarao",c6,4f,aa,c7),HX_("Joao idle",41,19,6d,9c),24,null(),null(),null());
...
HXDLIN(  24)			_g->set(HX_("joao-tubarao",c6,4f,aa,c7), ::CharacterSetting_obj::__alloc( HX_CTX ,50,90,((Float)1.9),null()));
HXDLIN(  24)			return _g;
            		}
