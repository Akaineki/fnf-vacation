...
HXLINE(  49)		::haxe::Log_obj::trace(jsonInput,::hx::SourceInfo(HX_("source_BROTHERS/Song.hx",31,01,15,86),49,HX_("Song",f5,4f,31,37),HX_("loadFromJson",f8,fc,9c,5d)));
...
HXDLIN(  58)		_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source_BROTHERS/Song.hx",31,01,15,86),58,HX_("Song",f5,4f,31,37),HX_("loadFromJson",f8,fc,9c,5d)));
