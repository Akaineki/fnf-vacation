...
HXLINE(  40)		::haxe::Log_obj::trace(HX_("this is dance double",92,8c,5e,ab),::hx::SourceInfo(HX_("source_BROTHERS/smTools/SMFile.hx",e2,c5,6f,0a),40,HX_("smTools.SMFile",e3,d5,c7,d6),HX_("new",60,d0,53,00)));
HXLINE(  42)		inc = (inc + 4);
HXLINE(  43)		::haxe::Log_obj::trace(data->__get(inc),::hx::SourceInfo(HX_("source_BROTHERS/smTools/SMFile.hx",e2,c5,6f,0a),43,HX_("smTools.SMFile",e3,d5,c7,d6),HX_("new",60,d0,53,00)));
...
HXLINE(  58)		::haxe::Log_obj::trace((this->measures->length + HX_(" Measures",95,d3,b0,47)),::hx::SourceInfo(HX_("source_BROTHERS/smTools/SMFile.hx",e2,c5,6f,0a),58,HX_("smTools.SMFile",e3,d5,c7,d6),HX_("new",60,d0,53,00)));
            	}
