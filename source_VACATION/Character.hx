...
class Character extends FlxSprite
{
    ...
    public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
    {
        ...
        switch (curCharacter)
        {
            ...
            case 'joao-tubarao':
                frames = Paths.getSparrowAtlas('joao_tubarao/joao_assets');
                animation.addByPrefix('idle', 'Joao idle', 24, false);
                animation.addByPrefix('singUP', 'Joao cima', 24, false);
                animation.addByPrefix('singDOWN', 'Joao baixo', 24, false);
                animation.addByPrefix('singLEFT', 'Joao esquerda', 24, false);
                animation.addByPrefix('singRIGHT', 'Joao direita', 24, false);
