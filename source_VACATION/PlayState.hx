	...
	override public function create()
	{
		...
		switch(stageCheck)
		{
			...
			case 'praia':
			{
				...
				var bg:FlxSprite = new FlxSprite(-558, -368).loadGraphic(Paths.image('joao_tubarao/ceu'));
				bg.antialiasing = true;
				...
				navio.frames = Paths.getSparrowAtlas('joao_tubarao/naviopassando');
				navio.animation.addByPrefix('navio', 'NAVIOPASSANDO', 24, true);
				navio.animation.play('navio');
				navio.scrollFactor.set(0.9, 0.9);
				add(navio);
			
				var mar:FlxSprite = new FlxSprite(-558, 343);
				mar.frames = Paths.getSparrowAtlas('joao_tubarao/maranimado');
				...
				*/
				...
				var caranguejo:FlxSprite = new FlxSprite(-10,650);
				caranguejo.antialiasing = true;
				caranguejo.frames = Paths.getSparrowAtlas('joao_tubarao/caranguejo');
				caranguejo.animation.addByPrefix('caranguejo', 'Caranguejo andando', 24, true);
				caranguejo.animation.play('caranguejo');
				caranguejo.scrollFactor.set(1, 1);
				add(caranguejo);

				var conchas:FlxSprite = new FlxSprite(-511, 558).loadGraphic(Paths.image('joao_tubarao/conchas'));
				conchas.antialiasing = true;
				conchas.scrollFactor.set(1, 1);
