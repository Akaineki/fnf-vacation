...
class TitleState extends MusicBeatState
{
    ...
    function startIntro()
    {
        ...
        /*GRADIENTE
        var gradiente:FlxSprite = new FlxSprite();
        gradiente.frames = Paths.getSparrowAtlas('GradienteBumpin');
        gradiente.antialiasing = true;
        gradiente.animation.addByPrefix('gradientebumpin', 'GRADIENTE BUMPIN', 24);
        gradiente.animation.play('gradientebumpin');
        add(gradiente);
        */
    ...
    override function beatHit()
    {
        ...
        switch (curBeat)
        {
            ...
            case 3:
                //
            case 4:
                createCoolText(['Akai', 'gustavo', 'Lucascito']);
            case 5:
                //
            case 6:
                addMoreText('');
